...
private static String DB_PATH="/data/data/com.example.tr4/databases/";
...
public void createDataBase()throws IOException{
	...
	if(dbExist){
		...
		this.getReadableDatabase();Log.d("createdatabase", "not exist");
		try{
			copyDataBase();
...
void copyDataBase()throws IOException{
	...
	myoutput.flush();
	myoutput.close();
	myinput.close();Log.d("copydatabase", "copyed");
}
public void openDataBase()throws SQLiteException{
	String mypath=DB_PATH+DB_NAME;
	myDataBase=SQLiteDatabase.openDatabase(mypath, null, SQLiteDatabase.OPEN_READWRITE);Log.d("opnedatabase", "poend");
}
